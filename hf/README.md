...
This dataset mirrors the deterministic fixture corpus from [DCAB v0.20.0](https://github.com/SybilGambleyyu/document-change-benchmark/tree/v0.20.0). It contains 31 paired synthetic WordprocessingML cases for static document-change assurance.
