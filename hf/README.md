...
This dataset mirrors the deterministic fixture corpus from [DCAB v0.22.0](https://github.com/SybilGambleyyu/document-change-benchmark/tree/v0.22.0). It contains 33 paired synthetic WordprocessingML cases for static document-change assurance.
