...
This dataset mirrors the deterministic fixture corpus from [DCAB v0.23.0](https://github.com/SybilGambleyyu/document-change-benchmark/tree/v0.23.0). It contains 34 paired synthetic WordprocessingML cases for static document-change assurance.
...
DCAB does not claim client rendering/runtime compatibility or universal security policy. It is a narrow, tool-neutral static-review benchmark. In particular, it does not resolve or follow links; retrieve sources, templates, frame documents, or mail-merge data; parse opaque macro, OLE, ActiveX, or alternative-format payloads; interpret unbound custom-XML data; update/evaluate fields; open Word; activate objects; execute code; synchronize comments or task panes; or assert client behavior. See the [repository README](https://github.com/SybilGambleyyu/document-change-benchmark) and [v0.23 research notes](https://github.com/SybilGambleyyu/document-change-benchmark/blob/v0.23.0/RESEARCH.md) for the exact contracts and limits.
